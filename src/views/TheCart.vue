        ...
        <div class="row d-flex justify-content-center">
            <div class="col-lg-10">
                ...
                <tbody v-if="cartItems.length != 0">
                    ...
                    <td><button @click="removeItem(item.song.id)" type="button" class="btn btn-danger">Delete</button></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <th></th>
                        <td><button @click="buy" type="button" class="btn btn-outline-success">Buy</button></td>
                        <td><button @click="clearCart" type="button" class="btn btn-outline-danger">Delete cart</button></td>
                    </tr>
                </tbody>
    ...
    methods:{
        ...
        async buy(){
            try{
                ...
                this.msg = "Thank you for your purchase! Your order has been successfully processed.";
                localStorage.removeItem("cart");
                setTimeout(() => {
